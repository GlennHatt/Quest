                ...
                <Columns>
                    <asp:TemplateField HeaderText="Delete">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdnStudentID" runat="server" Value='<%#Bind("student_id") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
...
SELECT end_user.f_name || ' ' || end_user.l_name as currently_enrolled, enrollment_id, student_id
  FROM end_user
       JOIN (SELECT user_id, enrollment_id, student_id
               FROM end_user
...
SELECT title || '/' || code || '-' || section_number || ' with ' || f_name || ' ' || l_name as full_information, section_id
  FROM section
       ...
       ORDER BY title asc"></asp:SqlDataSource>
