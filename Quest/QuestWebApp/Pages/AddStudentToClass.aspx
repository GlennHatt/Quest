    ...
    <div class="demo-card-wide mdl-shadow--3dp mdl-card" style="width: 70%; left: 17%">
     ...
     <div class="demo-card-wide mdl-shadow--3dp mdl-card" ID="cardAlreadyEnrolled" runat="server" style="width: 70%; left: 17%; margin-top:2%">
        <div class="mdl-card__supporting-text" style="text-align: center">
            ...
            <br />
            <br />
    <asp:GridView ID="gvCurrentStudents" runat="server" DataSourceID="sqlCurrentStudents" AutoGenerateDeleteButton="true" DataKeyNames="enrollment_id" OnRowDeleted="gvCurrentStudents_RowDeleted"></asp:GridView>
