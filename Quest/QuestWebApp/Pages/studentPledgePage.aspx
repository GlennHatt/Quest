...
<div class="demo-card-wide mdl-card mdl-shadow--3dp" style="margin-left: 30%;">
  ...
  <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="margin-left: 30%;">
    ...
    <asp:Button ID="btnCheat" runat="server" Text="I Cheated" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" style="margin-left: 50%; margin-bottom:-60px" ForeColor="#FF3300" OnClick="btnCheat_Click">
