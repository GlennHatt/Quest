   	...
   	[
	   	'<div class="material-datepicker hide" tabindex="0">',
	    	...
	    	'<section class="calendar no-select">', 
	    		'<a data-bind="click: prevMonth" class="control prev"> <i class="material-icons noTest">chevron_left</i> </a>',
	    		'<a data-bind="click: nextMonth" class="control next"> <i class="material-icons noTest">chevron_right</i> </a>',
